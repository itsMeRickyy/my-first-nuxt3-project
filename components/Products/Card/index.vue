...
<template>
  <div class="w-44 h-52 md:w-48 md:h-72 flex flex-col rounded-xl shadow-md relative overflow-hidden items-center">
    ...
    <NuxtLink :to="/product/ + props.product.id" class="p-7 w-28 h-28 md:p-14 md:w-48 md:h-48 bg-white overflow-hidden relative">
