...
<template>
  <div class="w-full h-16 flex justify-between items-center fixed top-0 left-0 z-40 bg-white border-b sm:px-5 md:px-10 lg:px-12 xl:px-40 2xl:px-[18rem]">
    <nuxtLink to="/" class="logo flex text-xl font-Pacifico">Classico</nuxtLink>
    ...
    <div class="flex gap-5">
      ...
      <div class="group relative">
        <nuxtLink to="/user" class="text-xl bg-gray-200 hover:bg-gray-300 rounded-lg p-2 grid place-items-center">
